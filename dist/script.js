...
class Form {
  constructor(form, btn) {
    ...
    this.form.addEventListener('submit', e => {
      ...
      this.form.classList.add('animated', 'fadeOutUp');
      setTimeout(() => {
        item.style.display = 'none';
      }, 400);
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  feedSlider.init();
  const player = new _modules_playVideo_js__WEBPACK_IMPORTED_MODULE_2__["default"]('.showup .play', '.overlay');
  player.init();
  new _modules_difference__WEBPACK_IMPORTED_MODULE_3__["default"]('.officerold', '.officernew', '.officer__card-item').init();
  new _modules_forms__WEBPACK_IMPORTED_MODULE_4__["default"]('.form', '.form__block .btn').init();
});
})();
